# Google Ads Script for Weather-Based Bid Adjustments and Ad Customization

This Google Ads script dynamically adjusts bids and customizes ad copy based on real-time weather conditions using a weather API. 
It ensures that the initial bid is preserved and can be reverted to, depending on weather changes.

## Key Features:

1. API Integration: Fetches weather data using a weather API.
2. Campaign Settings: Targets specific campaigns and locations.
3. Weather Conditions: Defines bid multipliers and ad copy for various weather conditions such as cloudy, rain, snow, and clear weather.
4. Bid Adjustments: Modifies bids based on weather conditions.
5. Ad Customization: Updates ad copy dynamically based on the current weather.
...
# Summary
This script helps optimize ad performance by ensuring that bids and ad copy are relevant to current weather conditions.This script helps optimize ad performance by ensuring that bids and ad copy are relevant tocurrent weather conditions.